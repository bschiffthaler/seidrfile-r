...
// SeidrFileHeader__ptr__getCentrality
NumericVector SeidrFileHeader__ptr__getCentrality(SEXP xp);
RcppExport SEXP _SeidRFile_SeidrFileHeader__ptr__getCentrality(SEXP xpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type xp(xpSEXP);
    rcpp_result_gen = Rcpp::wrap(SeidrFileHeader__ptr__getCentrality(xp));
    return rcpp_result_gen;
END_RCPP
}
// SeidrFileHeader__ptr__getCentralityNames
CharacterVector SeidrFileHeader__ptr__getCentralityNames(SEXP xp);
RcppExport SEXP _SeidRFile_SeidrFileHeader__ptr__getCentralityNames(SEXP xpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type xp(xpSEXP);
    rcpp_result_gen = Rcpp::wrap(SeidrFileHeader__ptr__getCentralityNames(xp));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_SeidRFile_SeidrFileHeader__ptr__getCentrality", (DL_FUNC) &_SeidRFile_SeidrFileHeader__ptr__getCentrality, 1},
    {"_SeidRFile_SeidrFileHeader__ptr__getCentralityNames", (DL_FUNC) &_SeidRFile_SeidrFileHeader__ptr__getCentralityNames, 1},
